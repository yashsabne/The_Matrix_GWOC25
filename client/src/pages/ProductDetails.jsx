...
const ProductDetails = () => {
  ...
  return (
    ...
    <div class="tags">
        <span class="tag">Online Exclusive</span>
    ...
    <h3>Blouse Stitching Options</h3>
    <div class="options">
        <button class="option-btn">Unstitched</button>
        <button class="option-btn">Stitched</button>
    </div>

    <h3>Convert into Ready to Wear Saree</h3>
    <label>
        <input type="checkbox"/> Pre Drape This Saree + ₹1,750.00
    </label>
